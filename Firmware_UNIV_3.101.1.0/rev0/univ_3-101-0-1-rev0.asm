...
;==============================================================================
;
;    Filename:				univ_3-101-0-1-rev0.asm
...
;==============================================================================
	...
	#define		FVERS	.01				    ;firmware version
...
;==============================================================================
	...
	#include "univ_3-101-0-1-rev0_cfg.inc"  ;firmware config
;==============================================================================
;===  FIRMWARE CHECKSUM  ======================================================
;==============================================================================
FIRMCHKSM   code    0x001000
    DB      0x6C,0xCA,0x43,0xFF,0xFF,0xFF,0xFF,0xFF
...
;===  MAIN PROGRAM  ===========================================================
;==============================================================================
TRANSEN  EQU R0     ;translation enabled byte (0xFF - translation disabled)
BAUDRATE EQU R1     ;uart baudrate - default 115200 if Config1 = 0xFF
...
ReadEepromConfig
		...
		clrf	EEADRH					;start reading from 0008h EEPROM address
        movlw   0x08                    
        movwf   EEADR
        lfsr    FSR0,TRANSEN            ;start writing to address of TRANSEN
        movlw   0x02                    ;x successive registers
ReadConfig
...
UARTCfgEnd
		...
		movwf	RCSTA1
    ;other
   		movlb	0x1 				    ;choose bootloader bank
...
;------------------------------------------------------------------------------
; Overview:         Transforms from UART ASCII to CAN HEX if found in config
;------------------------------------------------------------------------------
UartMsgTransform
        movlb   0x0
...
;check if translation in enabled
        tstfsz  TRANSEN        
        bra     ExitCanMsgTransform    ;translation disabled
